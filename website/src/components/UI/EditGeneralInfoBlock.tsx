...
import { nowToISODateString, timestampToISODateString } from "../../data/adapters/timeAdapters";
...
function EditGeneralInfoBlock({ heading, patient, onConfirmClick, onCancelClick, className }: Props) {
...
export default EditGeneralInfoBlock;
